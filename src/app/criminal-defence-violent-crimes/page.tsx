      ...
      <main>
        ...
        <section className="bg-white">
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            ...
            <div className="md:w-1/2"><img src="/assets/defence.png" alt="Violent crimes defence — Maurice Andrews Solicitors" className="block h-auto w-full" style={{aspectRatio: '1691 / 930'}} /></div>
          </div>
        </section>
