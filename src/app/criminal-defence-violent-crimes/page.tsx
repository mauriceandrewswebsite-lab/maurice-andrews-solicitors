...
export const metadata: Metadata = { title: "Violent Crimes | Maurice Andrews Solicitors" };

const subItems = [
  "ASSAULT AND BATTERY OFFENCES",
  "CONSPIRACY CHARGES",
  "FIREARMS AND WEAPON-RELATED",
  "HOMICIDE OFFENCES",
  "KIDNAPPING",
  "FALSE IMPRISONMENT",
...
const faqs = [
  { q: "How does Maurice Andrews Solicitors approach defence in violent crime cases?", a: "We provide expert legal advice, thorough investigation, and robust representation, exploring every avenue to challenge the allegations and aim for favorable outcomes." },
  { q: "What should I do if I am arrested for a violent crime?", a: "Contact Maurice Andrews Solicitors immediately for expert legal counsel. We will advise and represent you throughout the process, ensuring your rights are upheld." },
  { q: "Can Maurice Andrews Solicitors represent me in cases involving severe violent crimes?", a: "Absolutely, our experienced team has extensive knowledge in dealing with serious and complex violent crime cases, ensuring meticulous defence on all fronts." }
];
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-20">
              ...
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                Maurice Andrews Solicitors specialize in defending individuals accused of violent crimes, providing expert advice and dedicated representation to secure their rights and freedom.
              </p>
              <Link
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="Violent crimes defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-start bg-white px-6 pt-12 pb-12 text-left md:w-1/2 md:pt-16 md:pb-16">
              <h2 className="mb-6 text-2xl font-bold text-primary sm:text-[28px]">
                NATIONWIDE<br />VIOLENT CRIMES SOLICITORS
              </h2>
              <Link
                href="tel:01215544900"
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=VIOLENT%20CRIMES`}
