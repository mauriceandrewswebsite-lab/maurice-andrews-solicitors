      ...
      <main>
        ...
        <section className="bg-white">
          <div className="mx-auto flex max-w-[1240px] items-stretch flex-col md:flex-row">
            ...
            <div className="md:w-1/2 overflow-hidden"><img src="/assets/defence.png" alt="Traffic offences defence — Maurice Andrews Solicitors" className="block h-full w-full object-cover" /></div>
          </div>
        </section>
