...
export const metadata: Metadata = { title: "Traffic Offences | Maurice Andrews Solicitors" };
...
const faqs = [
  { q: "What are the penalties for traffic offences?", a: "Penalties vary depending on the severity of the offence. They can range from fines and penalty points to driving disqualification and even imprisonment for serious offences." },
  { q: "Can Maurice Andrews Solicitors help prevent a driving ban?", a: "Yes, our expert solicitors will explore all legal avenues to minimize penalties, including presenting mitigation to help you avoid or reduce the length of a driving ban." },
  { q: "What should I do if charged with a traffic offence?", a: "Contact Maurice Andrews Solicitors immediately. Our experienced team will advise you on the best approach and represent you throughout the proceedings." }
];
          ...
          <div className="mx-auto flex max-w-[1240px] items-stretch flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-16">
              ...
              <p className="mb-4 text-lg font-bold uppercase text-primary">
                TRAFFIC OFFENCES DEFENCE
              </p>
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                Maurice Andrews Solicitors deliver specialized legal services to those facing traffic offences, focusing on preserving their driving privileges and maintaining their records.
              </p>
              <Link
            ...
            <div className="md:w-1/2 overflow-hidden pt-3 md:pt-4"><img src="/assets/defence.png" alt="Traffic offences defence — Maurice Andrews Solicitors" className="block h-full w-full object-cover" /></div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=TRAFFIC%20OFFENCES`}
