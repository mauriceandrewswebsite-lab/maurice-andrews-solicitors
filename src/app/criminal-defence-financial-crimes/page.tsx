...
export const metadata: Metadata = { title: "Financial Crimes | Maurice Andrews Solicitors" };

const subItems = [
  "BANK FRAUD", "BRIBERY AND CORRUPTION", "CORPORATE AND BUSINESS FRAUD",
  "CYBER AND ONLINE FRAUD", "DECEPTION AND MISREPRESENTATION", "EMBEZZLEMENT AND MISAPPROPRIATION",
  "GOVERNMENT AND PUBLIC FRAUD", "INVESTMENT AND SECURITIES FRAUD", "MONEY LAUNDERING",
  "TAX CRIMES", "THEFT AND PROPERTY CRIMES", "I AM NOT SURE"
];
...
const faqs = [
  { q: "How can Maurice Andrews Solicitors assist in financial crime accusations?", a: "We provide expert legal advice, thorough investigation, and robust representation, exploring every avenue to challenge the allegations effectively and aim for favorable outcomes, including dismissal or reduced charges." },
  { q: "What should I do if I am under investigation for financial crimes?", a: "Contact Maurice Andrews Solicitors immediately for expert legal counsel. We can advise and represent you throughout the investigative process, ensuring your rights are upheld and exploring all possible defence strategies." },
  { q: "Can Maurice Andrews Solicitors handle complex financial crime cases involving multiple jurisdictions?", a: "Absolutely, our experienced team has extensive knowledge in dealing with complex, multi-jurisdictional financial crime cases, ensuring meticulous representation and defence on every front." },
];
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-20">
              ...
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                Maurice Andrews Solicitors deliver specialized representation and advice for those accused of financial crimes, ensuring comprehensive protection of their rights and interests.
              </p>
              <Link
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="Financial crimes defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-start bg-white px-6 pt-12 pb-12 text-left md:w-1/2 md:pt-16 md:pb-16">
              <h2 className="mb-6 text-2xl font-bold text-primary sm:text-[28px]">
                NATIONWIDE FINANCIAL CRIMES<br />SOLICITORS
              </h2>
              <Link
                href="tel:01215544900"
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=FINANCIAL CRIMES`}
