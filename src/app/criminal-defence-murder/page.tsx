      ...
      <main>
        ...
        <section className="bg-white">
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="Murder & manslaughter defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          </div>
        </section>
