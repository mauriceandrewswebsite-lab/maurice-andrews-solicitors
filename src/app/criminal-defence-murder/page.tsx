      ...
      <main>
        ...
        <section className="bg-white">
          <div className="mx-auto flex max-w-[1240px] items-stretch flex-col md:flex-row">
            ...
            <div className="md:w-1/2 overflow-hidden pt-3 md:pt-4"><img src="/assets/defence.png" alt="Murder & manslaughter defence — Maurice Andrews Solicitors" className="block h-full w-full object-cover" /></div>
          </div>
        </section>
