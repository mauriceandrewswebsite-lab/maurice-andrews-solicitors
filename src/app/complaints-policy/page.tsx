...
export const metadata: Metadata = { title: "Service Complaints Policy | Maurice Andrews Solicitors" };
      ...
      <main className="bg-white px-4 py-14">
        <div className="mx-auto max-w-[900px]">
          <h1 className="mb-8 border-b-[3px] border-primary pb-4 text-3xl font-bold text-primary">
            Maurice Andrews Service Complaints Policy
          </h1>
          ...
          <p className="mb-6 text-base leading-relaxed text-[#333]">
            In the first instance, it may be helpful to contact the person who is working on your case to discuss your concerns and we will do our best to resolve any issues at this stage. If you would like to make a formal complaint, then you can read our full complaints procedure below. Making a complaint will not affect how we handle your case and any investigation of a complaint is conducted free of charge.
          </p>

          <h2 className="mb-4 mt-8 text-xl font-bold text-primary">Our service complaints policy</h2>
          <p className="mb-4 text-base leading-relaxed text-[#333]">
            Maurice Andrews Solicitors is committed to providing a high-quality legal service to all our clients. When something goes wrong, we want you to tell us about it. This will help us to improve our standards.
          </p>

          <h2 className="mb-4 mt-8 text-xl font-bold text-primary">Our service complaints procedure</h2>
          <p className="mb-4 text-base leading-relaxed text-[#333]">
            If you have a concern or a complaint, please contact us as soon as you are aware of the problem so this can be addressed. If you feel concerned about the service you have received, then please contact Mariam Khan, Address: 182 Soho Hill, Birmingham, England, B19 1AG
          </p>
          ...
          <ul className="mb-6 ml-6 list-disc space-y-2 text-base leading-relaxed text-[#333]">
            <li>
              We will review your submission and respond to you with acknowledgement of receipt of your complaint within five working days of our having received it. If you have special requirements regarding the correspondence due to a disability, please let us know and we shall do our best to accommodate any alternative arrangements you may require.
            </li>
            <li>
              We will then investigate your complaint. This will normally involve passing your complaint to our complaints handling officer, Mariam Khan, who will review your matter file and speak to the member of staff who acted for you.
            </li>
            <li>
              The complaints handling officer will then respond to you in writing or call you to discuss and, it is hoped, resolve your complaint. She will do this within 14 working days of sending you the acknowledgement letter. Within 7 working days of the call, Mariam Khan will write to you to confirm what took place and any solutions she has agreed with you.
            </li>
            <li>
              Mariam Khan will then send you a detailed written reply to your complaint, including her suggestions for resolving the matter, within 21 working days.
            </li>
            <li>
            ...
            <li>
              If you are still not satisfied, you can then contact the Legal Ombudsman using the details that follow.
            </li>
          </ul>
          <p className="mb-4 text-sm italic text-[#666]">
            (Our timescales are subject to be amended depending on the complexity of the matter and submission. If we must change any of the timescales above, we will let you know and explain why.)
          </p>
          ...
          {/* Cross-reference to Data Protection Complaints (newly added 01 Jul 2026) */}
          <h2 className="mb-4 mt-8 text-xl font-bold text-primary">
            Complaints about Data Protection
          </h2>
          <p className="mb-4 text-base leading-relaxed text-[#333]">
            For complaints relating to data protection or how we have handled your data please see our{" "}
            <a href="/data-protection-complaints-procedure" className="text-[#3C78F4] hover:underline">
              Data Protection Complaints Procedure
            </a>
            .
          </p>
          <p className="mb-6 text-sm italic text-[#666]">
            This policy covers service complaints only (legal advice quality, fees, conduct). For data protection complaints, see the linked procedure.
          </p>
        </div>
