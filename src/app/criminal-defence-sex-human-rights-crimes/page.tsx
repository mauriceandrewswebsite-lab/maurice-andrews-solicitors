...
export const metadata: Metadata = { title: "Sex & Human Rights | Maurice Andrews Solicitors" };
...
const faqs = [
  { q: "How can Maurice Andrews Solicitors assist in sex crime cases?", a: "We provide expert legal advice, thorough investigation, and confidential representation, exploring every avenue to protect your rights and reputation." },
  { q: "What should I do if accused of a human rights crime?", a: "Contact Maurice Andrews Solicitors immediately for expert counsel. We will advise and represent you, ensuring your rights are fully upheld throughout." },
  { q: "Can Maurice Andrews Solicitors handle complex sex and human rights crime cases?", a: "Yes, our experienced team has extensive knowledge in handling complex and sensitive cases, ensuring meticulous and discreet representation." }
];
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-20">
              ...
              <p className="mb-4 text-lg font-bold uppercase text-primary">
                SEX & HUMAN RIGHTS CRIMES DEFENCE
              </p>
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                Maurice Andrews Solicitors offer specialized defence services for those facing allegations related to sex and human rights crimes, ensuring their rights are protected throughout the legal proceedings.
              </p>
              <Link
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="Sex & human rights crimes defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-start bg-white px-6 pt-12 pb-12 text-left md:w-1/2 md:pt-16 md:pb-16">
              <h2 className="mb-6 text-2xl font-bold text-primary sm:text-[28px]">
                NATIONWIDE<br />SEX & HUMAN RIGHTS CRIMES SOLICITORS
              </h2>
              <Link
                href="tel:01215544900"
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=SEX%20%26%20HUMAN%20RIGHTS%20CRIMES`}
