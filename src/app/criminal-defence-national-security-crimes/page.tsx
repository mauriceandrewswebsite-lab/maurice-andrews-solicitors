...
export const metadata: Metadata = { title: "National Security | Maurice Andrews Solicitors" };
...
const faqs = [
  { q: "How does Maurice Andrews Solicitors approach national security crime charges?", a: "We provide expert legal advice, thorough investigation, and robust representation, navigating the complexities of national security cases while protecting your rights." },
  { q: "Can Maurice Andrews Solicitors handle cases involving classified or sensitive information?", a: "Yes, our experienced team is equipped to handle cases involving classified and sensitive information, ensuring proper protocols are followed throughout the legal process." },
  { q: "What should I do if I am accused of committing a national security crime?", a: "Contact Maurice Andrews Solicitors immediately for expert legal counsel. We will advise and represent you throughout the investigation and legal proceedings, ensuring your rights are fully protected." }
];
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-20">
              ...
              <p className="mb-4 text-lg font-bold uppercase text-primary">
                NATIONAL SECURITY CRIMES DEFENCE
              </p>
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                Maurice Andrews Solicitors provide expert defence for individuals accused of national security crimes, upholding their rights and freedom through strategic legal representation.
              </p>
              <Link
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="National security crimes defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=NATIONAL%20SECURITY%20CRIMES`}
