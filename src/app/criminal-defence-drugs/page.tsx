...
export const metadata: Metadata = { title: "Drugs | Maurice Andrews Solicitors" };
...
const faqs = [
  { q: "How does Maurice Andrews Solicitors approach defence in drug crime cases?", a: "We approach each drug crime case with a thorough investigation, rigorous evidence examination, and robust legal strategies designed to protect your rights and aim for the best possible outcome." },
  { q: "What should I do if I am arrested for a drug crime?", a: "Remain calm, exercise your right to remain silent, and contact Maurice Andrews Solicitors immediately. Our expert team will guide you through the legal process and represent your interests from the outset." },
  { q: "Can Maurice Andrews Solicitors represent me in cases involving severe drug crimes?", a: "Absolutely, our experienced team has extensive knowledge in dealing with complex drug crime cases, ensuring meticulous representation and defence on every front." },
  { q: "How can Maurice Andrews Solicitors support me in dealing with drug offence charges?", a: "We provide expert legal counsel, thorough case analysis, and strategic representation to challenge the charges and aim for the most favorable outcome." },
  { q: "Can Maurice Andrews Solicitors assist with cases involving drug importation or supply charges?", a: "Yes, we have significant experience in handling serious drug importation and supply cases, providing robust defence strategies tailored to the specifics of your case." },
  { q: "What are my rights if I am arrested on suspicion of a drug offence, and how can Maurice Andrews Solicitors help?", a: "You have the right to remain silent and the right to legal representation. Maurice Andrews Solicitors will ensure your rights are protected throughout the investigation and any subsequent proceedings." }
];
          ...
          <div className="mx-auto flex max-w-[1240px] flex-col md:flex-row">
            <div className="flex flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 md:py-20">
              ...
              <p className="mb-4 text-lg font-bold uppercase text-primary">
                DRUGS OFFENCE DEFENCE
              </p>
              <p className="mb-8 max-w-[500px] text-[15px] leading-relaxed text-[#555]">
                At Maurice Andrews Solicitors, we specialize in defending individuals accused of drug offences. We offer expert advice and robust representation to uphold their rights throughout every stage of the legal process.
              </p>
              <Link
            ...
            <div className="relative min-h-[420px] md:w-1/2"><img src="/assets/defence.png" alt="Drugs offence defence — Maurice Andrews Solicitors" className="absolute inset-0 h-full w-full object-cover" /></div>
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {subItems.map((item, i) => (
                <Link
                  key={i}
                  href={`/contactUs?serviceName=DRUGS`}
